...
set dest_prefix = "script/Lead2X0PbBlock_ZeroSpt_Hex";
#set dest_prefix = "script/Lead2X0PbBlock_HalfcmSpt_Hex";
#set dest_prefix = "script/Lead2X0PbBlock_1cmSpt_Hex";
#set dest_prefix = "script/Lead2X0PbBlock_Spt_Hex";
#set dest_prefix = "script/Lead2X0PbBlock_Hex";
#set dest_prefix = "script/SIDIS_Forward_PhotonRej";
#set dest_prefix = "script/PVDIS_HERAb";
