...
//	EvsFiber->SetOption("colz");
	...
	hHit_XY_VtxE = new TH3F("hHit_XY_VtxE", "Lateral Energy Distribution;X (mm);Y (mm);Vertex Energy (GeV)", 60, -300, 300, 60, -300, 300, 10, 0, 10);
...
//			}
			...
			hHit_XY_VtxE->Fill((pos.x() - vtxPos.x())/mm, (pos.y() - vtxPos.y())/mm,vtxE/GeV, edep);
